...
| ---- | ---- | ------- | -------- | ---------------- | -------- | ------- | ------- |
| id | char(36) |  | false |  | [group_keys](group_keys.md) [group_members](group_members.md) [invitations](invitations.md) [mails](mails.md) [secrets](secrets.md) [user_keys](user_keys.md) [user_links](user_links.md) [user_statuses](user_statuses.md) [webhooks](webhooks.md) |  | UUID v4 |
