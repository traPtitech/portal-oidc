...
CREATE TABLE `group_keys` (
  ...
  KEY `idx_group_keys_user` (`user_id`),
  KEY `fk_group_keys_user_key` (`user_id`,`key_id`),
...
| user_id | char(36) |  | false |  | [users](users.md) [user_keys](user_keys.md) |  |
| key_id | char(36) |  | false |  | [user_keys](user_keys.md) | UUID v4 |
...
| fk_group_keys_user_key | FOREIGN KEY | FOREIGN KEY (user_id, key_id) REFERENCES user_keys (user_id, key_id) |
...
| Name | Definition |
| ---- | ---------- |
| fk_group_keys_user_key | KEY fk_group_keys_user_key (user_id, key_id) USING BTREE |
| idx_group_keys_user | KEY idx_group_keys_user (user_id) USING BTREE |
