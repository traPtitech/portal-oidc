...
var (
	userDBTypes = map[string]string{`ID`: `varchar`, `Password`: `varchar`, `Salt`: `varchar`, `Email`: `varchar`, `StudentNumber`: `varchar`, `PhoneNumber`: `tinytext`, `Postcode`: `varchar`, `Address`: `text`, `Birthdate`: `varchar`, `Name`: `tinytext`, `AlphabeticName`: `tinytext`, `Nickname`: `tinytext`, `Sex`: `tinytext`, `StudentPrefix`: `varchar`, `Department`: `text`, `Affiliation`: `text`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`}
	_           = bytes.MinRead
)
